...
public class FirebaseStorageService {
    ...
    final String BucketName = "tienda-62beb.firebasestorage.app"; // se copia el id del proyecto
    ...
    final String rutaJsonFile = "firebase"; // el nombre de la carpeta de default

    //El nombre del archivo Json
    final String archivoJsonFile = "tienda-62beb-firebase-adminsdk-fbsvc-822789d543"+".json";
