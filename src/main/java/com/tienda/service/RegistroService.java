...
public class RegistroService {
    ...
    @Autowired
    private MessageSource messageSource; // archivos de mensaje
    @Autowired
    private FirebaseStorageService firebaseStorageService;

    //Este metodo se usa cuando se va a activar un usuario via el correo enviado, por medio del link enviado
    ...
    //Este metodo se usa cuando finalmente se termina activar el usuario, ya con foto
